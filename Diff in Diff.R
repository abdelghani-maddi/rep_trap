...
# 
# # Safety
# panel_did[, total_pub_author_year := coalesce(total_pub_author_year.x, total_pub_author_year.y)]
# 
...
# )
# 
# # (3) Count model with explicit control for author-year publication scale
# # NOTE: with author_year_fe included, log_total_pub_author_year is collinear
# # and will be absorbed. So to estimate a scale control explicitly,
# # we use author FE + year FE instead of author_year FE.
# 
...
# )
# 
# # (4) Poisson model with high-dimensional FE
...
# )
# 
# # Joint pre-trend test for the share model
...
# 
# # ------------------------------------------------------------
# # 12B.4 Conference-friendly descriptive plots for relative reallocation
# # ------------------------------------------------------------
# 
# # A. GAP plot
# gap_df <- panel_did %>%
...
# 
# # ------------------------------------------------------------
# # 12B.5 Save model comparison table
# # ------------------------------------------------------------
# names(coef(m_did_base_jfe))
# names(coef(m_did_share))
# names(coef(m_did_control_scale))
# names(coef(m_did_pois_scale))
# names(coef(m_event_study_share))
# 
# modelsummary(
#   list(
...
#   ),
#   output = file.path(out_dir, "tables", "did_scale_robustness.html"),
#   stars = TRUE,
#   statistic = "({std.error})"
# )
# 
# # Scale-controlled DiD: cleaner specification
# m_did_control_scale <- feols(
#   n_pub ~ treated_journal:post + log_total_pub_author_year |
#     author_fe + year_fe + source_id,
#   cluster = ~ author_id,
...
# 
# robustness_lines <- c(
#   paste("Baseline DiD + Journal FE:", interpret_coef(m_did_base_jfe, "treated_journal:post")),
#   paste("Share outcome:", interpret_coef(m_did_share, "treated_journal:post")),
#   paste("Scale-controlled DiD:", interpret_coef(m_did_control_scale, "treated_journal:post")),
#   paste("Poisson FE:", interpret_coef(m_did_pois_scale, "treated_journal:post"))
# )
# 
# writeLines(
#   robustness_lines,
...
# message("- Table: ", file.path(out_dir, "tables", "did_scale_robustness.html"))
# message("- Table note: ", file.path(out_dir, "tables", "did_scale_robustness_interpretation.txt"))
# message("- Figures: gap_listed_vs_nonlisted.png, index_listed_vs_nonlisted.png, share_listed_vs_nonlisted.png, event_study_share.png")
# 
